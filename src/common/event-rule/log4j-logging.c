...
static enum lttng_error_code lttng_event_rule_log4j_logging_mi(
		const struct lttng_event_rule *rule, struct mi_writer *writer)
{
	...
	/* Close event_rule_log4j_logging. */
...
struct lttng_event_rule *lttng_event_rule_log4j_logging_create(void)
{
	...
	tp_rule->parent.mi = lttng_event_rule_log4j_logging_mi;
