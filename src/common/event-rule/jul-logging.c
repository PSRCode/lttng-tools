...
static enum lttng_error_code lttng_event_rule_jul_logging_mi(
...
struct lttng_event_rule *lttng_event_rule_jul_logging_create(void)
{
	...
	tp_rule->parent.mi = lttng_event_rule_jul_logging_mi;
