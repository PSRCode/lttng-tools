...
static
enum lttng_error_code lttng_condition_session_consumed_size_mi(const struct lttng_condition *condition, struct mi_writer *writer)
{
	int ret;
...
struct lttng_condition *lttng_condition_session_consumed_size_create(void)
{
	...
	condition->parent.mi = lttng_condition_session_consumed_size_mi;
